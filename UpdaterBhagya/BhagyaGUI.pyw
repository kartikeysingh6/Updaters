...
root = Tk()
root.title('Bhagya Updater')
root.configure(bg="#e2df7a")   # light yellow
...
label = Label(root, text='Welcome!', fg='black', font='Verdana 30 bold', bg="#e2df7a")
label.pack()

f = Frame(root, bg="#e2df7a")
f.pack(anchor='center', pady=5)

btn_style = {"bg": "#fffbd0"}  # light yellow buttons
